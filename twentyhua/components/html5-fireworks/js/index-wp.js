var Fireworks = function(){
    ...
    self.dt = 0;
		...
		self.canvasContainer = jQuery('#canvas-container');
		...
		console.dir(canvasContainerDisabled.offsetWidth);
		console.dir(canvasContainerDisabled.offsetHeight);
		self.canvas.width = self.cw = canvasContainerDisabled.offsetWidth;
		self.canvas.height = self.ch = canvasContainerDisabled.offsetHeight;
	...
	self.bindEvents = function(){
		...
		jQuery(self.canvas).on('mousedown', function(e){
			...
			jQuery(self.canvas).on('mousemove.fireworks', function(e){
				var randLaunch = rand(0, 5);
				self.mx = e.pageX - self.canvasContainer.offset().left;
				self.my = e.pageY - self.canvasContainer.offset().top;
				self.currentHue = rand(self.hueMin, self.hueMax);
		...
		jQuery(self.canvas).on('mouseup', function(e){
			jQuery(self.canvas).off('mousemove.fireworks');									
		});
